...
ggsave(file.path(FIG_OUT, "Revision_producer_sensitivity_no2020.pdf"),
       p_rank_compare, width = 100, height = 90, units = "mm")
ggsave(file.path(FIG_OUT, "Revision_producer_sensitivity_no2020.png"),
...
write.csv(temp_cor_table,
          file.path(TAB_OUT, "Revision_temporal_climate_correlations.csv"),
          row.names = FALSE)
```
...
ggsave(file.path(FIG_OUT,"Revision_temporal_climate_correlations.pdf"),
       temporal_plot, width=140, height=90, units="mm")
ggsave(file.path(FIG_OUT,"Revision_temporal_climate_correlations.png"),
...
write.csv(m_mixed_summary,
          file.path(TAB_OUT,"Revision_mixed_effects_GLM_VIZ_COUNT.csv"),
          row.names=FALSE)
...
write.csv(glmm_main,
          file.path(TAB_OUT, "Revision_mixed_effects_GLM_litter_trap.csv"),
          row.names = FALSE)
...
write.csv(soil_contrasts,
          file.path(TAB_OUT, "Revision_GLMM_ABORTED_soil_contrasts.csv"),
          row.names = FALSE)
```
...
ggsave(file.path(FIG_OUT,"Revision_predictor_correlation_matrix.pdf"),
       corr_plot, width=140, height=130, units="mm")
ggsave(file.path(FIG_OUT,"Revision_predictor_correlation_matrix.png"),
...
write.csv(cor_df,
          file.path(TAB_OUT,"Revision_predictor_correlation_matrix.csv"),
          row.names=FALSE)
...
write.csv(rank_cors,
          file.path(TAB_OUT,"Revision_rank_stability_across_years.csv"),
          row.names=FALSE)
```
